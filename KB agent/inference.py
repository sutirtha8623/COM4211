"""Library of logic functions for Assignment 6

This module contains two items for use in assignment 6.
...
class KnowledgeBasedAgent:
  ...
  def maybe_unsafe(self):
    """Return the set of locations that can't be proven safe to move to."""
    raise NotImplementedError()
  ...
  def choose_location(self, x , y, cave_size):
    ### Implement this method definition
    ### AI-Lab assignment 3.1
    valid = self.safe().intersection(self.unvisited())
    return min(valid)